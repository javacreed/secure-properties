 ...
 */
@NotThreadSafe
public class CipherStringDecoder extends AbstractCipherBase implements StringDecoder {

  /**
   *
   */
  public CipherStringDecoder() {
    super();
  }
   ...
   */
  public CipherStringDecoder(final CipherFactory cipherFactory) throws NullPointerException {
    super(cipherFactory);
  }
   ...
   *
   */
  public CipherStringDecoder(final String key) {
    super(key);
  }
